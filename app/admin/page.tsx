...
export default async function AdminDashboardPage() {
    ...
    const stats = [
        ...
        { label: "Global Modules", value: moduleCount, icon: Layers, color: "text-indigo-400", bg: "bg-indigo-400/10" },
        { label: "Total Items", value: itemCount, icon: CheckCircle2, color: "text-emerald-400", bg: "bg-emerald-400/10" },
        { label: "Library Connections", value: libraryCount, icon: TrendingUp, color: "text-amber-400", bg: "bg-amber-400/10" },
    ];
    ...
    return (
        <div className="space-y-8">
            <header>
                ...
                <p className="text-slate-400 mt-2">Sistem genelindeki verilere ve istatistiklere genel bakış.</p>
            </header>
                ...
                <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl">
                    ...
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                        ...
                        <p className="text-slate-500 italic max-w-xs">
                            Şu an için kaydedilmiş sistem aktivitesi bulunmuyor.
                        </p>
                    </div>
                </div>
                ...
                <div className="p-8 rounded-3xl bg-slate-900 border border-slate-800 shadow-xl">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between p-5 rounded-2xl bg-slate-800/40 border border-slate-800 hover:border-slate-700 transition-colors">
                            ...
                            <span className="px-3 py-1 rounded-full text-[10px] font-black bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 shadow-[0_0_15px_rgba(16,185,129,0.1)]">CONNECTED</span>
                        </div>
                        <div className="flex items-center justify-between p-5 rounded-2xl bg-slate-800/40 border border-slate-800 hover:border-slate-700 transition-colors">
                            <div className="flex flex-col">
                            ...
                            <span className="px-3 py-1 rounded-full text-[10px] font-black bg-indigo-500/10 text-indigo-400 border border-indigo-500/20">OPERATIONAL</span>
                        </div>
                        <div className="flex items-center justify-between p-5 rounded-2xl bg-slate-800/40 border border-slate-800 hover:border-slate-700 transition-colors">
                            <div className="flex flex-col">
                            ...
                            <span className="px-3 py-1 rounded-full text-[10px] font-black bg-slate-700/50 text-slate-400 border border-slate-700">PRODUCTION</span>
                        </div>
                    </div>
                </div>
            </div>
