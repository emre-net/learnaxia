...
export function FlashcardRenderer({ item }: { item: any }) {
    ...
    return (
        <div
            className="w-full max-w-2xl h-[400px] cursor-pointer perspective-1000"
        ...
        >
            ...
            >
                {/* Front */}
                <Card
                    className="absolute w-full h-full flex flex-col items-center justify-center p-8 text-center bg-background border-2 shadow-xl hover:shadow-2xl transition-shadow backface-hidden"
                >
                ...
                {/* Back */}
                <Card
                    className="absolute w-full h-full flex flex-col items-center justify-center p-8 text-center bg-secondary/10 border-2 border-primary/20 shadow-xl backface-hidden rotate-y-180"
                >
                    <div className="flex flex-col gap-4">
