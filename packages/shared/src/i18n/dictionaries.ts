...
const en = {
    ...
    auth: {
        ...
        registerTitle: "Start your learning journey",
    ...
    create: {
        ...
        cameraModal: {
            frameQuestion: "Frame the Question",
            takePhoto: "Take Photo",
            fromGallery: "Choose from Gallery",
            galleryDesc: "Upload photo to generate solution",
            solutionReady: "Solution is Ready",
            questionText: "Question Text",
            aiSolution: "AI Solution",
            understood: "Understood",
            photoError: "Failed to analyze photo.",
            galleryError: "Failed to analyze gallery photo.",
            largeImageWarning: "Warning",
            largeImageDesc: "The selected image is very large and will be compressed."
        }
    },
    solvePhoto: {
    ...
    creation: {
        ...
        depthShallow: "Shallow (Summary Only)",
        depthStandard: "Standard (Balanced)",
        depthDeep: "Comprehensive (Expert Detail)",
        depthDescription: "Determines how deeply this topic will be covered.",
        syllabusTitle: "Learning Syllabus",
        syllabusDesc: "Your study plan extracted by AI. You can remove unwanted sections or modify the structure with the helper buttons.",
        syllabusExpand: "Expand Syllabus",
        syllabusCondense: "Make it Shorter",
        syllabusTechnical: "Make it More Technical",
        ...
        aiConfig: "Content Configuration",
        aiDescription: "Tell us what you want to learn, and the system will generate the content.",
        textTab: "Text / Topic",
        ...
        autoCount: "Auto (System Decides)",
        generateButton: "Start Generating",
        generatingContent: "Creating your content...",
        analyzingContent: "The system is analyzing your data and creating the educational content.",
        reviewContent: "Review Generated Content",
        itemsReady: "{count} items ready to save.",
        aiNotes: {
            title: "Smart Note Workshop",
            description: "Upload a PDF, the system will analyze the most important parts and convert them to notes for you.",
    ...
    analytics: {
        ...
        weeklyProgressDesc: "You studied 12% more than last week.",
...
const tr = {
    ...
    auth: {
        ...
        personalizedAI: "Kişiselleştirilmiş Yapay Zeka",
        loginTitle: "Hesabınıza giriş yapın",
        registerTitle: "Öğrenme yolculuğuna başla",
        passwordMin: "Parola (En az 8 karakter)",
    ...
    create: {
        ...
        cameraModal: {
            frameQuestion: "Soruyu Çerçeveye Alın",
            takePhoto: "Fotoğraf Çek",
            fromGallery: "Galeriden Seç",
            galleryDesc: "Fotoğraf yükleyerek çözüm üret",
            solutionReady: "Çözüm Hazır",
            questionText: "Soru Metni",
            aiSolution: "Yapay Zeka Çözümü",
            understood: "Anladım",
            photoError: "Fotoğraf analiz edilemedi.",
            galleryError: "Galeri fotoğrafı analiz edilemedi.",
            largeImageWarning: "Uyarı",
            largeImageDesc: "Seçilen resim boyutu çok büyük olduğu için sıkıştırılarak yüklenecek."
        }
    },
    solvePhoto: {
    ...
    creation: {
        ...
        depthLabel: "Öğrenim Derinliği",
        depthShallow: "Sığ (Sadece Özet)",
        depthStandard: "Standart (Dengeli)",
        depthDeep: "Kapsamlı (Uzman Detayı)",
        depthDescription: "Bu konunun ne kadar detaylı işleneceğini belirler.",
        syllabusTitle: "Öğrenme Müfredatı (Syllabus)",
        syllabusDesc: "AI tarafından çıkarılan çalışma planınız. İstemediğiniz maddeleri çıkarabilir veya destekleyici butonlarla yapıyı değiştirebilirsiniz.",
        syllabusExpand: "Müfredatı Genişlet",
        syllabusCondense: "Daha Kısa Yap",
        syllabusTechnical: "Daha Teknik Yap",
        ...
        aiConfig: "İçerik Yapılandırması",
        aiDescription: "Ne öğrenmek istediğinizi söyleyin, eğitim içeriğini sistem oluştursun.",
        textTab: "Metin / Konu",
        fileTab: "Dosya Yükle",
        ...
        autoCount: "Otomatik (Sistem Karar Versin)",
        generateButton: "Sistemi Başlat",
        generatingContent: "İçeriğiniz oluşturuluyor...",
        analyzingContent: "Sistem, verileri analiz ediyor ve eğitim içeriğini hazırlıyor.",
        reviewContent: "Üretilen İçeriği İncele",
        itemsReady: "{count} öğe kaydedilmeye hazır.",
        aiNotes: {
            title: "Akıllı Not Atölyesi",
            description: "PDF yükleyin, sistem en önemli yerleri analiz edip notlara dönüştürsün.",
    ...
    profile: {
        ...
        settings: {
            ...
            logout: "Çıkış Yap",
            comingSoon: "Yakında",
            comingSoonDesc: "Bu özellik gelecek güncellemelerde eklenecektir."
        }
    },
    dashboard: {
    ...
    validation: {
        ...
        categoryRequired: "Lütfen bir kategori seçin (Herkese açık modüller için zorunludur)",
        subCategoryRequired: "Lütfen bir alt kategori seçin"
    },
    analytics: {
        analyzing: "Analiz ediliyor...",
        title: "İstatistikler",
        last7Days: "SON 7 GÜN (DAKİKA)",
        performanceSummary: "PERFORMANS ÖZETİ",
        accuracyRate: "DOĞRU ORANI",
        totalSolved: "TOPLAM ÇÖZÜLEN",
        weeklyProgress: "HAFTALIK İLERLEME",
        weeklyProgressDesc: "Geçen haftaya göre %12 daha fazla çalıştınız.",
        moduleMastery: "MODÜL USTALIĞI"
    }
};
